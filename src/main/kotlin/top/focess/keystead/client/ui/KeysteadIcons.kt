...
val BackupIcon: ImageVector by lazy {
    materialIcon(
        "Backup",
        "M19.35 10.04A7.49 7.49 0 0 0 5.14 7.5 5.994 5.994 0 0 0 6 19h13a5 5 0 0 0 .35-8.96zM13 13v4h-2v-4H8l4-4 4 4h-3z",
    )
}

val AccountIcon: ImageVector by lazy {
    materialIcon(
        "Account",
...
val RecoveryIcon: ImageVector by lazy {
    materialIcon(
        "Recovery",
        "M13 3a9 9 0 0 0-8.83 7H1l4 4 4-4H6.18A7 7 0 1 1 7 16.9l-1.42 1.42A9 9 0 1 0 13 3zm-1 5v5l4.25 2.52.77-1.28-3.52-2.09V8H12z",
    )
}
